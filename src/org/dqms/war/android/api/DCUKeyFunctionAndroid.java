...
@WebServlet("/DCUKeyFunctionAndroid")
public class DCUKeyFunctionAndroid extends HttpServlet {
	...
	private void _doWork(boolean isPost, HttpServletRequest request,
		...
		String roomNo = DCUKeyFunctionAndroid.getRequestString(request, PARM_ROOMNO,"");
		int functionType = Integer.parseInt(DCUKeyFunctionAndroid.getRequestString(request, PARM_FUNCTIONTYPE, "0"));
		int type = (Integer.parseInt(DCUKeyFunctionAndroid.getRequestString(request,
				PARM_TYPE, "0")));
		int listType = (Integer.parseInt(DCUKeyFunctionAndroid.getRequestString(
				request, PARM_LISTTYPE, "0")));
		int lastTokenNo = (Integer.parseInt(DCUKeyFunctionAndroid.getRequestString(
				request, PARM_TREATTOKENNO, "0")));
		int userID = (Integer.parseInt(DCUKeyFunctionAndroid.getRequestString(request,
				PARM_DOCTORID, "0")));
		...
		if (functionType == 1) {
			...
			obj.put("total_token_doctor",
					new 
					Integer(docSummary.getTotal_token_doctorID()));
